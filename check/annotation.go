...
type Annotation interface {
	...
	// from A-Z and ending in a period.
	Message() string
...
func (a *annotation) toProto() *checkv1beta1.Annotation {
	if a == nil {
		return nil
	}
	var protoLocation *checkv1beta1.Location
	if a.location != nil {
		protoLocation = a.location.toProto()
	}
	var protoAgainstLocation *checkv1beta1.Location
