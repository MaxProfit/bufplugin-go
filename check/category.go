...
type Category interface {
	...
	//
	// If the Category is deprecated, it may be replaced by 0 or more Categories. These will be denoted
	// by ReplacementIDs.
	Deprecated() bool
...
func (r *category) toProto() *checkv1beta1.Category {
	if r == nil {
		return nil
	}
	return &checkv1beta1.Category{
		Id:             r.id,
		Purpose:        r.purpose,
...
func categoryForProtoCategory(protoCategory *checkv1beta1.Category) (Category, error) {
	return newCategory(
		protoCategory.GetId(),
...
func validateNoDuplicateCategories(categories []Category) error {
