...
var (
	...
	ruleTypeToProtoRuleType = map[RuleType]checkv1beta1.RuleType{
		RuleTypeLint:     checkv1beta1.RuleType_RULE_TYPE_LINT,
		RuleTypeBreaking: checkv1beta1.RuleType_RULE_TYPE_BREAKING,
	}
	protoRuleTypeToRuleType = map[checkv1beta1.RuleType]RuleType{
		checkv1beta1.RuleType_RULE_TYPE_LINT:     RuleTypeLint,
		checkv1beta1.RuleType_RULE_TYPE_BREAKING: RuleTypeBreaking,
	}
)
